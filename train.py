...
VALID_RATIO = 25
lr = 0.0008
ct = input('c = continue \nother key = new trening \n then Enter :) \n')
if str(ct).lower() == 'c':
    continue_training = True
    print('continue_training = True \n')
else:
    continue_training = False
    print('continue_training = False \n')
...
x_test = x_train[:int(split_ix)]
y_test = y_train[:int(split_ix)]
x_train = x_train[int(split_ix):]
y_train = y_train[int(split_ix):]
...
print ("Loading Keras...")
import os, math
os.environ['THEANORC'] = "./gpu.theanorc" #0 to delete
